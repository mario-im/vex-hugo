...
import { autoriFields } from "./templates";
import { chisiamoFields } from "./templates";
import { postFields } from "./templates";
import { essenzeFields } from "./templates";
import { suisekiFields } from "./templates";
...
export default defineConfig({
  branch,
  clientId: "ade5ebf8-4ccc-47a1-bad2-bcfe1eed7f34", // Get this from tina.io
  token: "c86c79688c80c926304b3224fdd26e5016a82b9d", // Get this from tina.io
  client: { skip: true },
  build: {
    outputFolder: "admin",
    publicFolder: "static",
  ...
  schema: {
    collections: [
      ...
      },
      {
        ...
        match: {
          include: "calendario-incontri-2023",
        },
        fields: [
          {
            type: "rich-text",
